  ...
  return (
    ...
    <div className='firstposter'>
        <div className='brandkithead'>
            ...
            <p>You’re encouraged to use the official colors when displaying the logo and marks. When using the logo type on light backgrounds, use our charcoal color when possible. Use white if displaying on dark backgrounds .</p>
