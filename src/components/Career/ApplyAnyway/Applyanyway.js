...
const Applyanyway = () => {
  return (
    ...
    <div className='aplyany'>
        ...
        <pre className='lastline'>or send us an email with your resume to <a href="mailto:career@sperax.io">careers@sperax.io</a> </pre>
        <p className='lastlinemob'>or send us an email with your resume to <a href="mailto:career@sperax.io">careers@sperax.io</a></p>
