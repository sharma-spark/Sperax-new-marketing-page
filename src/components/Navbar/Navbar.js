        ...
        <div className='Navbar'>
            ...
            <div className='leftPart'>
                ...
                <div className='textlinks'>
                    ...
                    <a className='linktext' href="https://docs.sperax.io/" target={`_blank`}>Docs</a>
                    <a className='linktext' href="https://forum.sperax.io/" target={`_blank`}>Forum</a>
            ...
            <div className='rightPart mobileRight'>
                ...
                <div className="mobileMenu">
                    ...
                    {show && <div className="mobileMenuContainer">
                        <a href="https://docs.sperax.io/" target={`_blank`}>Docs</a>
